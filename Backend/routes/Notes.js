...
// ROUTE 3: Update an existing Note using: PUT "/api/authenticate/updateNotes". Login required
...
// ROUTE 4: Delete an existing Note using: DELETE "/api/authenticate/deleteNotes". Login required
